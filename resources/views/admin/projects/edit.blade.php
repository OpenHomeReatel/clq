...
<div class="card">
    ...
    <div class="card-body">
        <form enctype="multipart/form-data" method="POST" novalidate action="{{ route("admin.projects.update", [$project->id]) }}" >
            @method('PUT')
            @csrf
            <div class="row g-2">
            ...
            <div class="row g-2">
                <div class="form-group col-md">
                    ...
                    <input class="form-control {{ $errors->has('emirate') ? 'is-invalid' : '' }}" type="text" name="emirate" id="emirate" value="{{ old('emirate', $project->emirate) }}" required>
                ...
                <div class="form-group col-md">
                    ...
                    <input class="form-control {{ $errors->has('community') ? 'is-invalid' : '' }}" type="text" name="community" id="community" value="{{ old('community', $project->community) }}" required>
            ...
            <div class="row g-2">
                ...
                <div class="form-group col-md">
                    ...
                    <input class="form-control {{ $errors->has('developer') ? 'is-invalid' : '' }}" type="text" name="developer" id="developer" value="{{ old('developer', $project->developer) }}" required>
                ...
                <div class="form-group col-md">
                    ...
                    <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $project->state) }}">
                    @if($errors->has('state'))
                    <div class="invalid-feedback">
                        {{ $errors->first('state') }}
                    </div>
            ...
            <div class="row g-2">
                <div class="form-group col-md">
                    ...
                    <select class="form-control  select2 {{ $errors->has('property_type') ? 'is-invalid' : '' }}" name="property_type[]" id="property_type" required multiple="">
                        ...
                        <option value="{{ $key }}" {{ in_array($key, $project->property_type) ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md">
                    ...
                    <input class="form-control {{ $errors->has('floor_number') ? 'is-invalid' : '' }}" type="number" name="floor_number" id="floor_number" value="{{ old('floor_number', $project->floor_number) }}" step="1">
                ...
                <div class="form-group col-md">
                    ...
                    <select class="form-control select2 {{ $errors->has('owner') ? 'is-invalid' : '' }}" name="owner_id" id="owner_id" >
                        ...
                        <option value="{{ $id }}" {{ (old('owner_id') ? old('owner_id') : $project->owner->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('owner'))
                    <div class="invalid-feedback">
            ...
            <div class="row g-2">
                <div class="form-group col-md">
                    <label for="note">{{ trans('cruds.project.fields.note') }}</label>
                    <textarea class="form-control ckeditor {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $project->note) }}</textarea>
                    @if($errors->has('note'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note') }}
                    </div>
                ...
                <div class="form-group col-md">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $project->description) }}</textarea>
            ...
            <div class="row g-2">
                <div class="form-group col-md">
                    <label for="thumbnail">{{ trans('cruds.project.fields.thumbnail') }}</label>
