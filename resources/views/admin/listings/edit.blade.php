...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" novalidate action="{{ route("admin.listings.update", [$listing->id]) }}" enctype="multipart/form-data" class="row g-3">
            @method('PUT')
            @csrf
            <div class="form-group col-md-6">
                <label class="required" for="title">{{ trans('cruds.listing.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $listing->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    <option value="{{ $key }}" {{ old('type', $listing->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-6">
                ...
                <select onchange="yesnoCheck(this);" class="form-control {{ $errors->has('purpose') ? 'is-invalid' : '' }}" name="purpose" id="purpose" required>
                    ...
                    <option value="{{ $key }}" {{ old('purpose', $listing->purpose) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div id="ifYes" class="form-group col-md-6" style="display: none ;">
                ...
                <select class="form-control {{ $errors->has('rent_pricing_duration') ? 'is-invalid' : '' }}" name="rent_pricing_duration" id="rent_pricing_duration">
                    ...
                    <option value="{{ $key }}" {{ old('rent_pricing_duration', $listing->rent_pricing_duration) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('emirate') ? 'is-invalid' : '' }}" type="text" name="emirate" id="emirate" value="{{ old('emirate', $listing->emirate) }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('community') ? 'is-invalid' : '' }}" type="text" name="community" id="community" value="{{ old('community', $listing->community) }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $listing->price) }}" step="0.01" required>
                @if($errors->has('price'))
                <div class="invalid-feedback">
                    {{ $errors->first('price') }}
                </div>
            ...
            <div class="form-group col-md-6">
                ...
                <!-- comment<input class="form-control {{ $errors->has('beds') ? 'is-invalid' : '' }}" type="number" name="beds" id="beds" value="{{ old('beds', $listing->beds) }}" step="1" required>
                -->   <select id="beds" name="beds" class="form-control form-control-lg {{ $errors->has('beds') ? 'is-invalid' : '' }}">
                    <option value="{{ old('beds', $listing->beds) }}">{{ old('beds', $listing->beds) }}</option>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('baths') ? 'is-invalid' : '' }}" type="text" name="baths" id="baths" value="{{ old('baths', $listing->baths) }}" step="1" required>
                @if($errors->has('baths'))
                <div class="invalid-feedback">
                    {{ $errors->first('baths') }}
                </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('plotarea_size') ? 'is-invalid' : '' }}" type="number" name="plotarea_size" id="plotarea_size" value="{{ old('plotarea_size', $listing->plotarea_size) }}" step="0.01" >
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('area_size') ? 'is-invalid' : '' }}" type="number" name="area_size" id="area_size" value="{{ old('area_size', $listing->area_size) }}" step="0.01" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('area_size_postfix') ? 'is-invalid' : '' }}" type="text" name="area_size_postfix" id="area_size_postfix" value="{{ old('area_size_postfix', $listing->area_size_postfix) }}"  required>
            ...
            <div class="form-group col-md-6">
                <label for="area">Plot Area Size Postfix </label>
                <input class="form-control {{ $errors->has('plotarea_size_postfix') ? 'is-invalid' : '' }}" type="text" name="plotarea_size_postfix" id="plotarea_size_postfix" value="{{ old('plotarea_size_postfix', $listing->plotarea_size_postfix) }}" >
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('developer') ? 'is-invalid' : '' }}" type="text" name="developer" id="developer" value="{{ old('developer', $listing->developer) }}">
            ...
            <div class="form-group col-md-6">
                <label for="note">{{ trans('cruds.listing.fields.note') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $listing->note) }}</textarea>
                @if($errors->has('note'))
                <div class="invalid-feedback">
                    {{ $errors->first('note') }}
                </div>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $listing->description) }}</textarea>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" name="state" id="state" required>
                    ...
                    <option value="{{ $key }}" {{ old('state', $listing->state) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('state'))
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control select2 {{ $errors->has('owner') ? 'is-invalid' : '' }}" name="owner_id" id="owner_id" required>
                    ...
                    <option value="{{ $id }}" {{ (old('owner_id') ? old('owner_id') : $listing->owner->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('owner'))
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-6">
                <label for="user_id">{{ trans('cruds.listing.fields.user') }}</label>
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $entry)
                    <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $listing->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="project_id" id="project_id">
                    @foreach($projects as $id => $entry)
                    <option value="{{ $id }}" {{ (old('project_id') ? old('project_id') : $listing->project->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                <label for="thumbnail">{{ trans('cruds.listing.fields.thumbnail') }}</label>
