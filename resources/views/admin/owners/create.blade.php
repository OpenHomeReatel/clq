    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.owners.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.owner.fields.salutation') }}</label>
                <select class="form-control {{ $errors->has('salutation') ? 'is-invalid' : '' }}" name="salutation" id="salutation">
            ...
            <div class="row g-2">
                <div class="form-group col-md">
                    ...
                    <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email') }}" placeholder="name@example.com" required>
                    @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
                ...
                <div class="form-group col-md">
                    ...
                    <input class="form-control {{ $errors->has('emirate_id_number') ? 'is-invalid' : '' }}" type="string" name="emirate_id_number" id="emirate_id_number" value="{{ old('emirate_id_number') }}" placeholder="ex:784-0000-0000000-0" >
            ...
            <div class="row g-2">
                ...
                <div class="form-group col-md">
                    ...
                    <select class="form-control select2 {{ $errors->has('assign') ? 'is-invalid' : '' }}" name="assign_id" id="assign_id" required>
                        @foreach($assigns as $id => $entry)
                        <option value="{{ $id }}" {{ old('assign_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group col-md">
                <label for="projects">{{ trans('cruds.owner.fields.projects') }}</label>               
                ...
                @endif
                <span class="help-block">{{ trans('cruds.owner.fields.projects_helper') }}</span>
            </div>
